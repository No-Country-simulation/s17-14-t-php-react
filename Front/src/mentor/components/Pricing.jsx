...
export default function Pricing({ mentor }) {
  ...
  return (
    <div className="p-6 bg-white shadow-lg rounded-lg border">
      ...
      <button className='mt-6 bg-gradient-primary text-white text-sm  py-1 px-4 border-2 border-violeta hover:bg-violeta2 rounded-tr-lg rounded-bl-lg whitespace-nowrap  select-none w-full'>Contratar</button>
    </div>
  );
}
