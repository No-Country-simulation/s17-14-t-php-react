...
import { faFacebook, faFacebookF, faInstagram, faLinkedin, faLinkedinIn, faXTwitter } from '@fortawesome/free-brands-svg-icons';

const Footer = () => {
  return (
    <footer className="bg-gray-50 text-black py-8 px-4 md:px-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-6 gap-8">
        ...
        <div className="md:col-span-2">
          ...
          <p className="mb-6 font-size-16">
            Únete a una red de mentores líderes de la industria que ofrecen asesoramiento estratégico. Eleva tu desarrollo profesional con mentorías personalizadas.
          </p>
          <div className="flex space-x-6">
            ...
            <a href="#" aria-label="X" className="text-black hover:text-gray-600">
        ...
        <div>
          ...
          <ul className="space-y-2 font-size-16">
            <li><a href="#" className="hover:underline">Explorar mentores</a></li>
            <li><a href="#" className="hover:underline">Reserva una sesión</a></li>
